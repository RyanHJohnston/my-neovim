...
_G.packer_plugins = {
  ...
  vimtex = {
    ...
    loaded = false,
    needs_bufread = true,
    path = "/home/ryanhjohnston/.local/share/nvim/site/pack/packer/opt/vimtex",
